...
void FuTestImpl::FuTestSignature(std::string Param1,
                                 FuTestMessageHelper invocation) {
...
void FuTestImpl::FuTestString(std::string Param1,
                              FuTestMessageHelper invocation) {
  invocation.ret(Param1);
}
...
void FuTestImpl::FuTestAll(
    std::vector<std::string> in_Param1, std::vector<std::string> in_Param2,
    std::vector<std::string> in_Param3, std::string in_Param4,
    std::string in_Param5, std::string in_Param6, std::string in_Param7,
    double in_Param8, guint64 in_Param9, gint64 in_Param10, guint32 in_Param11,
    gint32 in_Param12, guint16 in_Param13, gint16 in_Param14, guchar in_Param15,
    bool in_Param16, FuTestMessageHelper invocation) {}

void FuTestImpl::FuTestTriggerInternalPropertyChange(
    gint32 newValue, FuTestMessageHelper invocation) {
...
std::string FuTestImpl::FuTestPropReadString_get() {
  return m_PropReadStringValue;
}
...
double FuTestImpl::FuTestPropWriteDouble_get() {
  return m_PropWriteDoubleValue;
}
guint64 FuTestImpl::FuTestPropWriteUInt64_get() {
  return m_PropWriteUInt64Value;
}
...
guint16 FuTestImpl::FuTestPropWriteUInt16_get() {
  return m_PropWriteUInt16Value;
}
...
bool FuTestImpl::FuTestPropWriteBoolean_get() {
  return m_PropWriteBooleanValue;
}
...
gint32 FuTestImpl::FuTestPropReadWriteInt_get() {
  return m_PropReadWriteIntValue;
}
...
bool FuTestImpl::FuTestPropWriteDouble_setHandler(double value) {
  return false;
}
bool FuTestImpl::FuTestPropWriteUInt64_setHandler(guint64 value) {
  return false;
}
...
bool FuTestImpl::FuTestPropWriteUInt16_setHandler(guint16 value) {
  return false;
}
