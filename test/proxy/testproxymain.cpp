...
void printStatus(std::string message, bool isOK) {
  if (isOK) {
    std::cout << std::setw(60) << std::left << message << std::right
              << "\033[32m[  OK  ]\033[0m" << std::endl;
  } else {
    std::cout << std::setw(60) << std::left << message << std::right
              << "\033[31m[ FAIL ]\033[0m" << std::endl;
  }
}

void on_test_variant_finished(const Glib::RefPtr<Gio::AsyncResult> result,
                              Glib::ustring expectedBase) {
  Glib::VariantBase base;
  proxy->TestVariant_finish(base, result);

  // The proxy code has extracted the variant which should be a string so we can
  // cast it now
  std::string value;
  try {
...
void on_test_byte_string_array_finished(
...
void on_test_object_path_array_finished(
    const Glib::RefPtr<Gio::AsyncResult> result,
    std::vector<std::string> expected) {
  std::vector<std::string> res;
...
void on_test_all_finished(const Glib::RefPtr<Gio::AsyncResult> result) {
  ...
  proxy->TestAll_finish(resByteStringArray, resObjectPathArray, resStringArray,
                        resBytestring, resSignature, resObjectPath, resString,
                        resDouble, resUint64, resInt64, resUint, resInt,
                        resUint16, resInt16, resUchar, resBoolean, result);
  //    printStatus ("Boolean", res == expected);
}

void on_test_trigger_internal_property_change_finished(
    const Glib::RefPtr<Gio::AsyncResult> result, const int expected) {
  proxy->TestTriggerInternalPropertyChange_finish(result);

  printStatus("Internal property (read)",
              proxy->TestPropInternalReadPropertyChange_get() == expected);
  printStatus("Internal property (write/read)",
              proxy->TestPropInternalReadWritePropertyChange_get() == expected);
}
...
void on_test_prop_read_write_string(const Glib::RefPtr<Gio::AsyncResult> result,
  ...
  printStatus("Property (write/read): TestPropReadWriteString",
              actual == expected);
}

void on_test_prop_read_write_byte_string_array(
    const Glib::RefPtr<Gio::AsyncResult> result,
    const std::vector<std::string> &expected) {
  proxy->TestPropReadWriteByteStringArray_set_finish(result);
  std::vector<std::string> actual =
      proxy->TestPropReadWriteByteStringArray_get();
  printStatus("Property (write/read): TestPropReadWriteByteStringArray",
              actual == expected);
}

void on_test_prop_read_write_object_path_array(
    const Glib::RefPtr<Gio::AsyncResult> result,
    const std::vector<std::string> &expected) {
  proxy->TestPropReadWriteObjectPathArray_set_finish(result);
  std::vector<std::string> actual =
      proxy->TestPropReadWriteObjectPathArray_get();
  printStatus("Property (write/read): TestPropReadWriteObjectPathArray",
              actual == expected);
}

void on_test_prop_read_write_string_array(
    const Glib::RefPtr<Gio::AsyncResult> result,
    const std::vector<std::string> &expected) {
  proxy->TestPropReadWriteStringArray_set_finish(result);
  std::vector<std::string> actual = proxy->TestPropReadWriteStringArray_get();
  printStatus("Property (write/read): TestPropReadWriteStringArray",
              actual == expected);
}

void on_test_prop_read_write_byte_string(
    const Glib::RefPtr<Gio::AsyncResult> result, const std::string &expected) {
  proxy->TestPropReadWriteByteString_set_finish(result);
  std::string actual = proxy->TestPropReadWriteByteString_get();
  printStatus("Property (write/read): TestPropReadWriteByteString",
              actual == expected);
}

void on_test_prop_read_write_signature(
    const Glib::RefPtr<Gio::AsyncResult> result, const std::string &expected) {
  proxy->TestPropReadWriteSignature_set_finish(result);
  std::string actual = proxy->TestPropReadWriteSignature_get();
  printStatus("Property (write/read): TestPropReadWriteSignature",
              actual == expected);
}
...
void on_test_prop_read_write_double(const Glib::RefPtr<Gio::AsyncResult> result,
  ...
  printStatus("Property (write/read): TestPropReadWriteDouble",
              actual == expected);
}
...
void on_test_prop_read_write_uint64(const Glib::RefPtr<Gio::AsyncResult> result,
  ...
  printStatus("Property (write/read): TestPropReadWriteUInt64",
              actual == expected);
}
...
void on_test_prop_read_write_int64(const Glib::RefPtr<Gio::AsyncResult> result,
  ...
  printStatus("Property (write/read): TestPropReadWriteInt64",
              actual == expected);
}
...
void on_test_prop_read_write_uint(const Glib::RefPtr<Gio::AsyncResult> result,
  ...
  printStatus("Property (write/read): TestPropReadWriteUInt",
              actual == expected);
}
...
void on_test_prop_read_write_int(const Glib::RefPtr<Gio::AsyncResult> result,
  ...
  printStatus("Property (write/read): TestPropReadWriteInt",
              actual == expected);
}
...
void on_test_prop_read_write_uint16(const Glib::RefPtr<Gio::AsyncResult> result,
  ...
  printStatus("Property (write/read): TestPropReadWriteUInt16",
              actual == expected);
}
...
void on_test_prop_read_write_int16(const Glib::RefPtr<Gio::AsyncResult> result,
  ...
  printStatus("Property (write/read): TestPropReadWriteInt16",
              actual == expected);
}
...
void on_test_prop_read_write_char(const Glib::RefPtr<Gio::AsyncResult> result,
  ...
  printStatus("Property (write/read): TestPropReadWriteChar",
              actual == expected);
}

void on_test_prop_read_write_boolean(
    const Glib::RefPtr<Gio::AsyncResult> result, const guchar &expected) {
  proxy->TestPropReadWriteBoolean_set_finish(result);
  bool actual = proxy->TestPropReadWriteBoolean_get();
  printStatus("Property (write/read): TestPropReadWriteBoolean",
              actual == expected);
}
...
void proxy_created(const Glib::RefPtr<Gio::AsyncResult> result) {
  ...
  proxy->TestVariant(
      variantValue,
      sigc::bind(sigc::ptr_fun(&on_test_variant_finished), variantValue));

  /* Byte string array */
  proxy->TestByteStringArray(
      inputStrVec,
      sigc::bind(sigc::ptr_fun(&on_test_byte_string_array_finished),
                 inputStrVec));

  //    /* Object path array */
  //    proxy->TestObjectPathArray(inputObjPathVec,
  //    sigc::bind(sigc::ptr_fun(&on_test_object_path_array_finished),
  //    inputObjPathVec));

  /* String array */
  proxy->TestStringArray(
      inputObjPathVec, sigc::bind(sigc::ptr_fun(&on_test_string_array_finished),
                                  inputObjPathVec));

  /* Byte string */
  proxy->TestByteString(
      bytestring,
      sigc::bind(sigc::ptr_fun(&on_test_byte_string_finished), bytestring));

  /* Signature */
  proxy->TestSignature(
      signatureValue,
      sigc::bind(sigc::ptr_fun(&on_test_signature_finished), signatureValue));

  /* Object path */
  proxy->TestObjectPath(
      objectPath,
      sigc::bind(sigc::ptr_fun(&on_test_object_path_finished), objectPath));

  /* String */
  proxy->TestString(
      stringValue,
      sigc::bind(sigc::ptr_fun(&on_test_string_finished), stringValue));

  /* Double */
  proxy->TestDouble(
      doubleValue,
      sigc::bind(sigc::ptr_fun(&on_test_double_finished), doubleValue));

  /* UInt64 */
  proxy->TestUInt64(
      uint64Value,
      sigc::bind(sigc::ptr_fun(&on_test_uint64_finished), uint64Value));

  /* Int64 */
  proxy->TestInt64(
      int64Value,
      sigc::bind(sigc::ptr_fun(&on_test_int64_finished), int64Value));

  /* UInt */
  proxy->TestUInt(uintValue,
                  sigc::bind(sigc::ptr_fun(&on_test_uint_finished), uintValue));

  /* Int */
  proxy->TestInt(intValue,
                 sigc::bind(sigc::ptr_fun(&on_test_int_finished), intValue));

  /* UInt16 */
  proxy->TestUInt16(
      uint16Value,
      sigc::bind(sigc::ptr_fun(&on_test_uint16_finished), uint16Value));

  /* Int16 */
  proxy->TestInt16(
      int16Value,
      sigc::bind(sigc::ptr_fun(&on_test_int16_finished), int16Value));

  /* Char */
  proxy->TestChar(ucharValue, sigc::bind(sigc::ptr_fun(&on_test_uchar_finished),
                                         ucharValue));

  /* Boolean */
  proxy->TestBoolean(
      booleanValue,
      sigc::bind(sigc::ptr_fun(&on_test_boolean_finished), booleanValue));
  ...
  proxy->TestTriggerInternalPropertyChange(
      42, sigc::bind(
              sigc::ptr_fun(&on_test_trigger_internal_property_change_finished),
              42));
  ...
  printStatus("Property (read): TestPropReadByteStringArray",
              proxy->TestPropReadByteStringArray_get() ==
                  PropReadByteStringArrayValue);
  ...
  printStatus("Property (read): TestPropReadObjectPathArrayValue",
              proxy->TestPropReadObjectPathArray_get() ==
                  PropReadObjectPathArrayValue);
  ...
  printStatus("Property (read): TestPropReadStringArray",
              proxy->TestPropReadStringArray_get() == PropReadStringArrayValue);

  printStatus("Property (read): TestPropReadByteString",
              proxy->TestPropReadByteString_get() == "Value7");
  printStatus("Property (read): TestPropReadSignature",
              proxy->TestPropReadSignature_get() == "Value8");
  printStatus("Property (read): TestPropReadObjectPath",
              proxy->TestPropReadObjectPath_get() == "Value9");
  printStatus("Property (read): TestPropReadString",
              proxy->TestPropReadString_get() == "Value10");
  printStatus("Property (read): TestPropReadDouble",
              proxy->TestPropReadDouble_get() == 1337);
  printStatus("Property (read): TestPropReadUInt64",
              proxy->TestPropReadUInt64_get() == 1338);
  printStatus("Property (read): TestPropReadInt64",
              proxy->TestPropReadInt64_get() == 1339);
  printStatus("Property (read): TestPropReadUInt",
              proxy->TestPropReadUInt_get() == 1340);
  printStatus("Property (read): TestPropReadInt",
              proxy->TestPropReadInt_get() == 1341);
  printStatus("Property (read): TestPropReadUInt16",
              proxy->TestPropReadUInt16_get() == 1342);
  printStatus("Property (read): TestPropReadInt16",
              proxy->TestPropReadInt16_get() == 1343);
  printStatus("Property (read): TestPropReadChar",
              proxy->TestPropReadChar_get() == 'A');
  printStatus("Property (read): TestPropReadBoolean",
              proxy->TestPropReadBoolean_get() == true);
  ...
  printStatus("Property (read): TestPropReadWriteByteStringArray",
              proxy->TestPropReadWriteByteStringArray_get() ==
                  PropReadWriteByteStringArrayValue);

  std::vector<std::string> PropReadWriteObjectPathArrayValue;
  PropReadWriteObjectPathArrayValue.push_back("/object/path");

  printStatus("Property (read): TestPropReadWriteObjectPathArray",
              proxy->TestPropReadWriteObjectPathArray_get() ==
                  PropReadWriteObjectPathArrayValue);

  std::vector<std::string> PropReadWriteStringArrayValue;
  PropReadWriteStringArrayValue.push_back("Value24");
  printStatus("Property (read): TestPropReadWriteStringArrayValue",
              proxy->TestPropReadWriteStringArray_get() ==
                  PropReadWriteStringArrayValue);

  printStatus("Property (read): TestPropReadWriteByteString",
              proxy->TestPropReadWriteByteString_get() == "Value25");
  printStatus("Property (read): TestPropReadWriteSignature",
              proxy->TestPropReadWriteSignature_get() == "Value26");
  printStatus("Property (read): TestPropReadWriteObjectPath",
              proxy->TestPropReadWriteObjectPath_get() == "Value27");
  printStatus("Property (read): TestPropReadWriteString",
              proxy->TestPropReadWriteString_get() == "Value28");
  printStatus("Property (read): TestPropReadWriteDouble",
              proxy->TestPropReadWriteDouble_get() == 1351);
  printStatus("Property (read): TestPropReadWriteUInt64",
              proxy->TestPropReadWriteUInt64_get() == 1352);
  printStatus("Property (read): TestPropReadWriteInt64",
              proxy->TestPropReadWriteInt64_get() == 1353);
  printStatus("Property (read): TestPropReadWriteUInt",
              proxy->TestPropReadWriteUInt_get() == 1354);
  printStatus("Property (read): TestPropReadWriteInt",
              proxy->TestPropReadWriteInt_get() == 1355);
  printStatus("Property (read): TestPropReadWriteUInt16",
              proxy->TestPropReadWriteUInt16_get() == 1356);
  printStatus("Property (read): TestPropReadWriteInt16",
              proxy->TestPropReadWriteInt16_get() == 1357);
  printStatus("Property (read): TestPropReadWriteChar",
              proxy->TestPropReadWriteChar_get() == 'C');
  printStatus("Property (read): TestPropReadWriteBoolean",
              proxy->TestPropReadWriteBoolean_get() == true);
  ...
  //    proxy->TestPropReadWriteSignature_set("b",
  //    sigc::bind(sigc::ptr_fun(&on_test_prop_read_write_signature), "b"));
  proxy->TestPropReadWriteString_set(
      "Hello world", sigc::bind(sigc::ptr_fun(&on_test_prop_read_write_string),
                                "Hello world"));
  proxy->TestPropReadWriteDouble_set(
      7331, sigc::bind(sigc::ptr_fun(&on_test_prop_read_write_double), 7331));
  proxy->TestPropReadWriteUInt64_set(
      7332, sigc::bind(sigc::ptr_fun(&on_test_prop_read_write_uint64), 7332));
  proxy->TestPropReadWriteInt64_set(
      7333, sigc::bind(sigc::ptr_fun(&on_test_prop_read_write_int64), 7333));
  proxy->TestPropReadWriteUInt_set(
      7334, sigc::bind(sigc::ptr_fun(&on_test_prop_read_write_uint), 7334));
  proxy->TestPropReadWriteInt_set(
      7335, sigc::bind(sigc::ptr_fun(&on_test_prop_read_write_int), 7335));
  proxy->TestPropReadWriteUInt16_set(
      7336, sigc::bind(sigc::ptr_fun(&on_test_prop_read_write_uint16), 7336));
  proxy->TestPropReadWriteInt16_set(
      7337, sigc::bind(sigc::ptr_fun(&on_test_prop_read_write_int16), 7337));
  proxy->TestPropReadWriteChar_set(
      'X', sigc::bind(sigc::ptr_fun(&on_test_prop_read_write_char), 'X'));
  proxy->TestPropReadWriteBoolean_set(
      true, sigc::bind(sigc::ptr_fun(&on_test_prop_read_write_boolean), true));

  proxy->TestSignalByteStringArray_signal.connect(
      sigc::ptr_fun(&on_test_signal_byte_string_array_cb));
  proxy->TestSignalObjectPathArray_signal.connect(
      sigc::ptr_fun(&on_test_signal_object_path_array_cb));
  proxy->TestSignalStringArray_signal.connect(
      sigc::ptr_fun(&on_test_signal_string_array_cb));
  proxy->TestSignalByteString_signal.connect(
      sigc::ptr_fun(&on_test_signal_byte_string_cb));
  proxy->TestSignalSignature_signal.connect(
      sigc::ptr_fun(&on_test_signal_signature_cb));
  proxy->TestSignalObjectPath_signal.connect(
      sigc::ptr_fun(&on_test_signal_object_path_cb));
  proxy->TestSignalString_signal.connect(
      sigc::ptr_fun(&on_test_signal_string_cb));
  proxy->TestSignalDouble_signal.connect(
      sigc::ptr_fun(&on_test_signal_double_cb));
  proxy->TestSignalUInt64_signal.connect(
      sigc::ptr_fun(&on_test_signal_uint64_cb));
  proxy->TestSignalInt64_signal.connect(
      sigc::ptr_fun(&on_test_signal_int64_cb));
...
int main() {
  ...
  org::gdbus::codegen::glibmm::Test::createForBus(
      Gio::DBus::BUS_TYPE_SESSION, Gio::DBus::PROXY_FLAGS_NONE,
      "org.gdbus.codegen.glibmm.Test", "/org/gdbus/codegen/glibmm/Test",
